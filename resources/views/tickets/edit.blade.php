        ...
        <div class="well well bs-component">
            <form class="form-horizontal" method="post">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label>
                            {{--Nếu trạng thái là 1 (đang chờ xử lý)--> không hiển thị gì, hộp kiểm sẽ không được chọn.
                            Nếu trạng thái là 0 (trả lời)--> hiển thị thuộc tính đã chọn, hộp kiểm được chọn.--}}
